...
ActiveRecord::Schema.define(version: 20141001170015) do
  ...
  create_table "blogs_movies", id: false, force: true do |t|
    t.integer "blog_id"
    t.integer "movie_id"
  end

  add_index "blogs_movies", ["blog_id", "movie_id"], name: "index_blogs_movies_on_blog_id_and_movie_id", using: :btree
